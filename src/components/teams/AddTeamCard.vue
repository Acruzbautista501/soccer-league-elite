...
const emit = defineEmits<{
  (e: 'create', region: 'Norte' | 'Golfo'): void
}>()
</script>
...
<template>
  ...
  >
    <div class="size-12 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 flex items-center justify-center group-hover:bg-primary/20 group-hover:text-primary mb-3">
